...
- mountinfo-collector 一个通用的 Processor ，它会在读取node上的 mountinfo 文件 （路径是宿主机的 /proc/1/mountinfo ）并记录文件内容
...
6. 查看 diagnosis 的进展（此处为了方便阅读对输出内容做了省略）：
   ...
   status:
     ...
     operationResults:
       ...
       diagnoser.bug.subpathremount.link: https://github.com/kubernetes/kubernetes/issues/68211
       diagnoser.bug.subpathremount.originaldstpath: /var/lib/kubelet/pods/29da79e5-386c-4e0d-82c1-215f93ff955d/volume-subpaths/logrotateconf/nginx-ingress-controller/1
       diagnoser.bug.subpathremount.originalsrcpath: /var/lib/kubelet/pods/29da79e5-386c-4e0d-82c1-215f93ff955d/volumes/kubernetes.io~configmap/logrotateconf/..2021_06_02_06_01_21.244319292/nginx.log//deleted
       diagnoser.bug.subpathremount.result: pod met a bug of subpath-remounting
       recover.kubernetes.bug.subpathremount.result: succeed
     phase: Succeeded
