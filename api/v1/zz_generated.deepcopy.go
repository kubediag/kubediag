...
func (in *AbnormalSpec) DeepCopyInto(out *AbnormalSpec) {
	*out = *in
	out.Log = in.Log
	in.KubernetesEvent.DeepCopyInto(&out.KubernetesEvent)
	in.PrometheusAlert.DeepCopyInto(&out.PrometheusAlert)
	in.NodeProbe.DeepCopyInto(&out.NodeProbe)
	in.PodProbe.DeepCopyInto(&out.PodProbe)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeProbe) DeepCopyInto(out *NodeProbe) {
	*out = *in
	if in.Exec != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeProbe.
func (in *NodeProbe) DeepCopy() *NodeProbe {
	if in == nil {
		return nil
	}
	out := new(NodeProbe)
