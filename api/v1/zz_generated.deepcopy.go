...
func (in *Checkpoint) DeepCopyInto(out *Checkpoint) {
	*out = *in
	if in.SynchronizedTasks != nil {
		in, out := &in.SynchronizedTasks, &out.SynchronizedTasks
...
func (in *CommonEventTemplate) DeepCopy() *CommonEventTemplate {
	...
	out := new(CommonEventTemplate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonEventTemplateRegexp) DeepCopyInto(out *CommonEventTemplateRegexp) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonEventTemplateRegexp.
func (in *CommonEventTemplateRegexp) DeepCopy() *CommonEventTemplateRegexp {
	if in == nil {
		return nil
	}
	out := new(CommonEventTemplateRegexp)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DiagnosisContext) DeepCopyInto(out *DiagnosisContext) {
	*out = *in
	...
	if in.Operations != nil {
		...
		*out = make(map[string]OperationContext, len(*in))
		for key, val := range *in {
			var outVal map[string]TaskContext
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(OperationContext, len(*in))
				for key, val := range *in {
...
func (in *SourceTemplate) DeepCopyInto(out *SourceTemplate) {
	*out = *in
	...
	if in.CommonEventTemplate != nil {
		in, out := &in.CommonEventTemplate, &out.CommonEventTemplate
		*out = new(CommonEventTemplate)
		**out = **in
	}
	if in.CronTemplate != nil {
		in, out := &in.CronTemplate, &out.CronTemplate
		*out = new(CronTemplate)
		**out = **in
	}
}
